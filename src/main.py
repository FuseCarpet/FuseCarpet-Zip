...
gui.terms2(terms='''By clicking "I agree", you agree to these terms:
    ...
    2. You are allowed to distribute this software IF IT IS MODIFIED and it does NOT make money, with credits: Original made by FuseCarpet at https://github.com/FuseCarpet
''')
